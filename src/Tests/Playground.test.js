...
it("calculates the dot product of two vectors", () => {
    expect(graph.dotProduct2D({ xPos: 3, yPos: 7 }, { xPos: 7, yPos: -3 })).toEqual(0)
    expect(graph.dotProduct2D({ xPos: -4, yPos: 5 }, { xPos: 5, yPos: 4 })).toEqual(0)
    expect(graph.dotProduct2D({ xPos: -2, yPos: -12 }, { xPos: -12, yPos: 2 })).toEqual(0)
    expect(graph.dotProduct2D({ xPos: 7, yPos: 1 }, { xPos: 1, yPos: -7 })).toEqual(0)
})
